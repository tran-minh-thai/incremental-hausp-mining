...
per-file seed and are distributed verbatim. `scripts/fetch_datasets.sh`
downloads the release asset of this repository and verifies the manifest;
`scripts/fetch_datasets.sh --verify-only` checks files already present.
